...
platformMenu = require('../package.json')?._zenitMenu?.menu

# Extended: Provides a registry for menu items that you'd like to appear in the
# application menu.
#
# An instance of this class is always available as the `zenit.menu` global.
#
# ## Menu CSON Format
#
...
module.exports =
class MenuManager
  constructor: ({@resourcePath, @keymapManager}) ->
