...
module.exports = (grunt) ->
  ...
  getVersion = (callback) ->
    ...
    {version} = require(path.join(grunt.config.get('zenit.appDir'), 'package.json'))
  ...
  grunt.registerTask 'set-version', 'Set the version in the plist and package.json', ->
    ...
    getVersion (error, version) ->
      ...
      if process.platform is 'darwin'
        ...
        args = [grunt.config.get('zenit.buildDir'), version]
        ...
        strings =
          FileDescription: 'Zenit'
          LegalCopyright: 'Copyright (C) 2015 Iegor Azuaga. All rights reserved'
          ProductName: 'Zenit'
